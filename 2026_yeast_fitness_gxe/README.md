...
| `Table_S8_ORF_go_enrichment.R`                                | GO enrichment results of PAV and CNV RF models saved in the "go_enrichment" sheet of table S8.            |
| `Table_S8_ORF_pwy_enrichment.R`                               | Pathway wanrichment results of PAV and CNV RF models saved in the "pathway_enrichment" sheet of table S8. |
| `Table_S8_SNP_go_enrichment.R`                                | GO enrichment results of the SNP RF models saved in the "go_enrichment" sheet of table S8.                |
